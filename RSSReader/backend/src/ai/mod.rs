...
pub use commands::{
    ...
    ai_reveal_prompt, ai_start_summary, ai_start_translation, ai_suggest_tags, ai_test_provider,
    ai_update_agent_settings, ai_update_model, ai_update_provider, ai_usage_report,
};
