...
- 当前发布包为 alpha 测试版，主要用于体验和测试，不代表正式稳定版本。

### 下载与安装

请从仓库的 [Releases](https://github.com/winnyinthemoo/RSSReader/releases) 页面下载对应平台的安装包。

Windows 最新测试版为 [v0.3.0-alpha.1](https://github.com/winnyinthemoo/RSSReader/releases/tag/v0.3.0-alpha.1)。下载 `Vortex_0.3.0_x64-setup.exe`，双击安装即可。

macOS 最新测试版为 [v0.3.0-macos-alpha.1](https://github.com/winnyinthemoo/RSSReader/releases/tag/v0.3.0-macos-alpha.1)。下载 `Vortex_0.3.0_aarch64.dmg`，打开后将 `Vortex.app` 拖入“应用程序”。
...
- Current release packages are alpha test builds and are not final stable releases.

### Download And Install

Download the installer for your platform from the [Releases](https://github.com/winnyinthemoo/RSSReader/releases) page.

The latest Windows test build is [v0.3.0-alpha.1](https://github.com/winnyinthemoo/RSSReader/releases/tag/v0.3.0-alpha.1). Download `Vortex_0.3.0_x64-setup.exe` and run the installer.

The latest macOS test build is [v0.3.0-macos-alpha.1](https://github.com/winnyinthemoo/RSSReader/releases/tag/v0.3.0-macos-alpha.1). Download `Vortex_0.3.0_aarch64.dmg`, open it, and drag `Vortex.app` into Applications.
